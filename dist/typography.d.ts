...
export declare const TYPOGRAPHY_USAGE: Readonly<{"displayContexts":["brand","page-title","section-title","detail-content-title","text-cover-title"],"bodySemiboldContexts":["list-item-title","dialog-title","sheet-title","popover-title","state-title","functional-page-title","functional-section-title","functional-subsection-title"],"bodyOnlyContexts":["control","navigation","username","rich-text-heading"],"utilityContexts":["numeric","time","counter"],"displayWeight":500,"listTitleWeight":600}>;
