...
export const ADAPTIVE_READING_SCROLL_MOBILE_PROFILE = Object.freeze({
  ...
  "trackVisual": "none",
  "backingBehavior": "none-retain-fields-for-compatibility",
  "collapsedEdgePlacement": "flush-to-page-right-safe-edge",
  "expandedEdgePlacement": "inset-by-edge-gap",
  "hitTargetPlacement": "inside-system-gesture-inset",
  "hitTargetAffectsVisualPlacement": false,
  "avoidInsets": [
    "sticky-header",
    "composer-entry",
    "system-safe-area",
  ...
  "minimumSameDirectionDistance": 40,
  "minimumAverageVelocity": 550,
  "minimumViewportVelocityFactor": 0.8,
  ...
  "appearDurationMs": 180,
  "appearCurve": "easeOutCubic",
  "interruptedTransitionBehavior": "continue-from-current-value",
  "remainingDurationRule": "full-duration-times-absolute-target-minus-current",
  ...
  "focusIndicatorBehavior": "platform-visible-focus-indicator-without-backing",
  "keyboard": [
    "ArrowUp",
    "ArrowDown",
    "Home",
