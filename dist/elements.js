...
export const INLINE_ELEMENT_STYLES = Object.freeze({
  ...
  "dice": {
    ...
    "layout": {
      ...
      "truncate": false,
      "icon": "none",
      "visibleAffordance": "none"
    },
    "labels": {
      "settled": "{notation} = {total}",
      "pending": "{notation} = ?",
      "visibleResult": "total-only",
      "resultBreakdown": "interactive-detail",
      "resultsSeparator": "、",
    ...
    "semantics": {
      "settledRole": "button",
      "pendingRole": "note",
      "settled": "骰子 {notation}，总计 {total}",
      "pending": "骰子 {notation}，待掷",
      "settledHint": "查看逐骰结果",
      "resultItem": "第 {index} 枚，{value} 点",
      "neverColorOnly": true
    },
    "interaction": {
      "settledActivation": "open-detail",
    ...
    "detail": {
      "title": "骰子结果",
      "resultsLabel": "逐骰结果",
      "resultOrder": "server-order",
      "resultIndexOrigin": 1,
      "resultLayout": "adaptive-number-tray",
      "resultCell": {
        "foreground": "foreground",
        "surface": "muted",
        "family": "utility",
      ...
      "calculation": {
        ...
        "negativeModifier": "−{absoluteModifier}",
        "zeroModifier": "omit",
        "subtotalSource": "sum-server-results",
        "totalSource": "server-total"
      }
    },
    "data": {
      "binding": "node-id",
    ...
    "editor": {
      ...
      "readingEquivalentScope": "visual-presentation",
      "selection": "atomic",
      "activation": "selection-only",
      "insertion": {
        "title": "插入骰子",
        "fields": [
          "quantity",
        ...
        "quickSideBehavior": "replace-sides-only",
        "layout": "responsive-expression-builder",
        "preview": "{notation} = ?",
        "previewBehavior": "live-canonical",
        "zeroModifier": "omit",
        "validationOwner": "backend-contracts"
      }
    },
    "settled": {
      "foreground": "onAccent",
...
export const ELEMENT_WEB_PROFILE = Object.freeze({
  ...
  "dice": {
    "hoverStateOpacity": 0.08,
    "pressedStateOpacity": 0.12,
    "detailSurface": "anchored-popover",
    "detailWidthRem": 22,
    "detailMaxHeightRem": 28,
    "detailOverflow": "internal-scroll",
    "detailViewportClamp": true,
    "explicitClose": true
  },
...
export const ELEMENT_MOBILE_PROFILE = Object.freeze({
  ...
  "dice": {
    "pressedStateOpacity": 0.12,
    "detailSurface": "bottom-sheet",
    "detailMaximumHeightFraction": 0.8,
    "detailOverflow": "internal-scroll",
    "safeArea": true,
    "explicitClose": true
  },
